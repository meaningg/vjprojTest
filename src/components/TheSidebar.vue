<template>
  <aside class="sidebar" :class="{ open: showDrawer }">
    ...
    <button @click="toggleBasicStrategy" class="toggle">
      ...
      >
        <path
          v-if="showBasicStrategy"
          d="M18,1H6C3.3,1,1,3.3,1,6v12c0,2.8,2.3,5,5,5h12c2.8,0,5-2.3,5-5V6C23,3.3,20.8,1,18,1z M19.1,7.3l-8.5,11.1
        ...
        <path
          v-else
          d="M18,3c1.7,0,3,1.3,3,3v12c0,1.7-1.3,3-3,3H6c-1.7,0-3-1.3-3-3V6c0-1.7,1.3-3,3-3H18 M18,1H6C3.3,1,1,3.3,1,6v12
